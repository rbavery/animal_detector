...
from animal_detector.ct_utils import truncate_float
import animal_detector.visualization.visualization_utils as viz_utils
...
class TFDetector:
    ...
    DEFAULT_RENDERING_CONFIDENCE_THRESHOLD = 0.7  # to render bounding boxes
